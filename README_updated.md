...
1. **Raw model** — a fact table of monthly line items (`data/`).
2. **P&L & ratios** — a formula-driven workbook that turns those line items into a monthly
   ...
   (`analysis/`).
3. **Dashboard** — the same numbers told visually for a leadership audience (`dashboard/`).
...
![P&L Dashboard preview](assets/dashboard_preview.png)
...
- **Fastest:** open [`dashboard/PL_Dashboard_Synthetic_2025.pdf`](dashboard/PL_Dashboard_Synthetic_2025.pdf).
- **The numbers behind the charts:** open
  [`analysis/PL_Ratios_Analysis_2025.xlsx`](analysis/PL_Ratios_Analysis_2025.xlsx) —
  the P&L statement and every ratio the dashboard visualises, as a working model.
- **Interactive:** download and open [`dashboard/PL_Dashboard_Synthetic_2025.html`](dashboard/PL_Dashboard_Synthetic_2025.html)
...
- **Rebuild in Power BI:** open the workbook and follow the `PBI_Setup_Guide` tab
  (summarised in [`docs/DATA_DICTIONARY.md`](docs/DATA_DICTIONARY.md)).
...
[`analysis/PL_Ratios_Analysis_2025.xlsx`](analysis/PL_Ratios_Analysis_2025.xlsx) is the
